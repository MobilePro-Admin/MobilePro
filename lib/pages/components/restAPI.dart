...
class RESTAPI {
  List<PlaceModel> dummyAllPlaces = [
    PlaceModel(
        ...
        imgUrl: "assets/images/leticia.jpg",
        rateperpackage: 400.0,
        rating: 3.8),
    PlaceModel(
        placeTitle: "Lago Tarapoto",
        description:
        ...
        imgUrl: "assets/images/lagotarapoto.jpg",
        rateperpackage: 350.0,
        rating: 5.0),
    PlaceModel(
        placeTitle: "Parque Amacayacú",
        description:
        ...
        imgUrl: "assets/images/parqueamacayacu.jpg",
        rateperpackage: 350.0,
        rating: 4.2),
    PlaceModel(
        placeTitle: "Reserva Natural Marasha",
        description:
        ...
        imgUrl: "assets/images/marasha.jpg",
        rateperpackage: 350.0,
        rating: 3.2),
    PlaceModel(
        placeTitle: "Santa Sofía o Isla de los Micos",
        description:
        ...
        imgUrl: "assets/images/isladelosmicos.jpg",
        rateperpackage: 350.0,
        rating: 4.9),
  ];
